...
xmlns:ds="http://www.w3.org/2000/09/xmldsig#">
    ...
    <cbc:ID>{{$notaDebito->prefijo.$notaDebito->numero}}</cbc:ID>
    ...
    <cbc:Note>{{$notaDebito->concepto}}</cbc:Note>
    ...
    <cac:DiscrepancyResponse>
        ...
        <cbc:Description>{{$notaDebito->concepto}}</cbc:Description>
    </cac:DiscrepancyResponse>
    ...
    <cac:DebitNoteLine>
        <cbc:ID>{{$i+1}}</cbc:ID>
        <cbc:DebitedQuantity unitCode="WSD">{{$productos[$i]->cantidad}}</cbc:DebitedQuantity>
