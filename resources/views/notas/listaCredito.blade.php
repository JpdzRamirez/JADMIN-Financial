...
@section('sub_title', 'Notas Crédito')

@section('sub_content')
	<div class="card">
		<div class="card-body">
            <form action="/contabilidad/notas_credito/filtrar" method="get" id="formNota"></form>
            <table class="table table-bordered" style="table-layout: fixed">
                ...
                <tbody>
                    @forelse($notasCredito as $nota)
                        <tr>
                            <td>{{ $nota->prefijo }}{{ $nota->numero }}</td>
                            <td>{{ $nota->fecha }}</td>   
            ...
            @if(method_exists($notasCredito,'links'))
                {{ $notasCredito->links() }}
            @endif			
		</div>
	</div>
