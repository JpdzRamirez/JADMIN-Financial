    ...
    <body>
        ...
        <table>
            <tr>
                ...
                @elseif($factura->prefijo == "FCA")
                    <th style="width: 20%">FACTURA DE COMPRA AJUSTE</th>
                @else
                <th style="width: 20%">DOCUMENTO SOPORTE</th>
                @endif
            </tr>
            <tr>
                <td style="background-color: lightgray; text-align: center">{{$factura->prefijo}} {{$factura->numero}}</td>
            </tr>
        </table>
        <hr>
        <div>
