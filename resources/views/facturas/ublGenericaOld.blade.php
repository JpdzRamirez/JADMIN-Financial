          ...
          <ext:ExtensionContent>
             <sts:DianExtensions>
                <sts:InvoiceControl>
                    ...
                    <sts:InvoiceAuthorization>18764019003451</sts:InvoiceAuthorization>
                    <sts:AuthorizationPeriod>
                         <cbc:StartDate>2021-10-04</cbc:StartDate>
                         <cbc:EndDate>2022-10-04</cbc:EndDate>
                     </sts:AuthorizationPeriod>
                     <sts:AuthorizedInvoices>
                         <sts:Prefix>{{$factura->prefijo}}</sts:Prefix>
                         <sts:From>415</sts:From>
                         <sts:To>5000</sts:To>
                    </sts:AuthorizedInvoices>
                    @else
                    <sts:InvoiceAuthorization>18764019002602</sts:InvoiceAuthorization>
                    <sts:AuthorizationPeriod>
                         <cbc:StartDate>2021-10-04</cbc:StartDate>
                         <cbc:EndDate>2022-10-04</cbc:EndDate>
                     </sts:AuthorizationPeriod>
