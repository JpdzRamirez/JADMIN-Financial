		...
		<div class="card-body">
            ...
            <form action="/mis_creditos/solicitar" method="POST" id="formcredito" accept-charset="UTF-8">
                    ...
                    <div class="col-md-6 col-xs-10">
                       <select name="tipo" id="tipo" class="form-control">
                           ...
                           @if ($condicion == "Propietario")
                                <option value="1">Plan Contractual y Extracontractual</option>
                                <option value="2">Plan SOAT</option>
                                <option value="6">Nanocrédito</option>
                                <option value="4">Libre Inversión</option>
                                <option value="5">Emprendimientos</option>
                ...
                <div class="form-group row">
                    ...
                    {{ Form::label('pareja', 'Tiempo con su pareja (años)', ['class' => 'col-md-1']) }}
                    <div class="col-md-3">
                        {{ Form::number('pareja', $cliente->personales->tiempo_pareja, ['required', 'class' => 'form-control']) }}
                    </div>
                ...
                <div class="form-group row">
                    ...
                    {{ Form::label('ejerciendo', 'Tiempo Ejerciendo (años)', ['class' => 'label-required col-md-2']) }}
                    <div class="col-md-4">
                        {{ Form::number('ejerciendo', $cliente->personales->tiempo_ocupacion, ['required', 'class' => 'form-control']) }}
                    </div>
                </div>
...
@section('script')
    <script>
        ...
        var validarform = 0;
        var planes = [{nombre: "1", montomin: 500000, montomax:2500000, plazo:10, divprop: "block", costo1: true, costo2: true, costo3: false, costo4: false, costo5: false, costo6: false, costo7: false},
        {nombre: "4", montomin: 500000, montomax:2500000,  plazo:12, divprop: "none", costo1: true, costo2: true, costo3: false, costo4: false, costo5: false, costo6: false, costo7: false},
        {nombre: "2", montomin: 100000, montomax:1000000, plazo:8, divprop: "true", costo1: true, costo2: true, costo3: false, costo4: false, costo5: false, costo6: false, costo7: false},
        {nombre: "6", montomin: 200000, montomax:{{$cupo}}, plazo:5, divprop: "none", costo1: false, costo2: true, costo3: false, costo4: false, costo5: false, costo6: false, costo7: false},
        {nombre: "5", montomin: 1000000, montomax:5000000, plazo:12, divprop: "none", costo1: true, costo2: true, costo3: false, costo4: true, costo5: false, costo6: false, costo7: false}];
