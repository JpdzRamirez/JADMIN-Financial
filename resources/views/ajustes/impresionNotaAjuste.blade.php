    ...
    <body>
        ...
        <table>
            <tr>
                ...
                <th style="width: 20%">NOTA AJUSTE</th>
            </tr>
            <tr>
                <td style="background-color: lightgray; text-align: center">{{$nota->prefijo}} {{$nota->id}}</td>
            </tr>
        </table>
        <hr>
        <div>
            ...
            <table class="table tb-border" style="font-size: 8pt">
                ...
                @foreach ($nota->movimientos as $movimiento)
                    <tr>
                        ...
                        @if ($movimiento->tercero->usuario != null)
