		...
		<div class="card-body">
            ...
            <div class="align-center">
				...
				<table class="table table-bordered" style="table-layout: fixed">
					...
					<tbody>
						@forelse($retefuentes as $retefuente)
							<tr>
								<td>{{ $retefuente->id }}</td>
                                <td>{{ $retefuente->concepto }}</td>                             
								<td>{{ number_format($retefuente->porcentaje, 2) }}%</td>
								<td>
									<button onclick="editar({{$retefuente->id}}, '{{$retefuente->concepto}}', {{$retefuente->porcentaje}}, {{$retefuente->venta->codigo}}, {{$retefuente->compra->codigo}})" class="btn btn-warning btn-sm">Editar</button>
								</td>
							</tr>
						@empty
...
@section('modal')
        ...
        <div class="modal-dialog" style="width: 50%">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Nuevo Retefuente</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <form action="/contabilidad/retefuentes/nuevo" method="POST">
    ...
    <div id="ModEditar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="Modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Editar Retefuente</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <form action="/contabilidad/retefuentes/editar" method="POST">
                    <input type="hidden" name="idretefuente" id="idretefuente">
                <div class="modal-body">
                    <div class="row form-group">
